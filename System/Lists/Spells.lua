    ...
    PRIEST = {
        ...
        [257] = {
            ...
            talents                         = {
                ...
                apotheosis                  = 200183,
                bodyAndSoul                 = 64129,
                --bodyAndMind                 = 214121, -- Patch 8.0.1 (2018-07-17): Removed.
                divineStar                  = 110744,
                --divinity                    = 197031, -- Patch 8.0.1 (2018-07-17): Removed.
                halo                        = 120517,
                --piety                       = 197034, -- Patch 8.0.1 (2018-07-17): Removed.
                shiningForce                = 204263,
                surgeOfLight                = 109186,
                --symbolOfHope                = 64901,
            },
        ...
        [258] = {
            abilities                       = {
--                damnation                   = 341374, -- Warlock Spell?
                darkAscension               = 391109, --Old 280711
                dispersion                  = 47585,
                devouringPlague             = 335467,
                mindBlast                   = 8092,
--                mindBomb                    = 205369, -- Patch 10.0.0 (2022-10-25): Removed.
                mindbender                  = 200174,
                mindFlay                    = 15407,
--				  mindSear                    = 172878, -- Patch 10.1.0 (2023-05-02): Removed.
                mindSpike		            = 73510,
                mindVision                  = 2096,
                powerInfusion               = 10060,
                powerWordShield             = 17,
...
--                massHysteria                = 194378,
            ...
            buffs                           = {
                ...
                powerWordShield             = 17,
                powerInfusion               = 10060,
				shadowyInsight              = 375888, --Old 124430 -- Patch 10.1.0 (2023-05-02): No longer passively grants an additional charge of Mind Blast., No longer temporarily increases the maximum charges of Mind Blast when it triggers.
                shadowform                  = 232698,
...
--                surrenderToMadness          = 193223,
            ...
            debuffs                         = {
                devouringPlague             = 335467,
--                hungeringVoid               = 345218, -- Patch 10.0.0 (2022-10-25): Removed.
                mindFlay                    = 15407,
                vampiricTouch               = 34914,
                weakenedSoul                = 6788,
            },
            ...
            talents                         = {
				angelicFeather              = 121536,
--                fortressOfTheMind           = 193195, -- Patch 10.0.0 (2022-10-25): Removed.
                deathAndMadness             = 321291,
                unfurlingDarkness           = 341273,
                bodyAndSoul                 = 64129,
                sanlayn                     = 199855,
                twistOfFate                 = 390972, --Old 109142 -- Patch 10.0.0 (2022-10-25): Now a row 7 class talent (was a level 15 Discipline and 45 Shadow talent). Now triggers from damage or healing for all priests (was healing for Discipline and damage for Shadow).
                misery                      = 238558,
--                searingNightmare            = 341385, --  Patch 10.0.0 (2022-10-25): Removed.
--                mindBomb                    = 205369, -- Patch 10.0.0 (2022-10-25): Removed.
                psychicHorror               = 64044,
...
--                damnation                   = 341374, -- Warlock Spell?
                ...
                halo                        = 120644,
--                hungeringVoid               = 345218, -- Patch 10.0.0 (2022-10-25): Removed.
--                surrenderToMadness          = 319952, -- Patch 10.0.0 (2022-10-25): Removed.
            },
            traits                          = {
        ...
        Shared = {
            ...
            buffs                           = {
				angelicFeather              = 121536,
                classHallSpeed              = 224098, --bodyAndSoul
                boonOfTheAscended           = 325013,
                faeGuardians                = 327661,
                levitate                    = 111759,
                powerWordFortitude          = 21562,
